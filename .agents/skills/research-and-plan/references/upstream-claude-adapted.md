...
description: >-
  Z Skills workflow adapted for Codex: Decompose a broad goal into a sequence
  of executable sub-plans. Researches the domain, identifies sub-problems and
  dependencies, then produces a meta-plan where each phase delegates to run-
  plan. Usage: research-and-plan [output FILE] <description...>
---
