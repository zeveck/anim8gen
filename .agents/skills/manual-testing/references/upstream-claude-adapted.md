...
name: manual-testing
description: >-
  Z Skills workflow adapted for Codex: Block-diagram editor manual testing
  recipes for playwright-cli. Covers common UI operations (adding blocks,
  connecting ports, running simulations, editing parameters) using real
  mouse/keyboard events. Use when told to "test manually", "test in the
