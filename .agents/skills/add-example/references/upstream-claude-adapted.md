...
name: add-example
description: >-
  Z Skills workflow adapted for Codex: Create an example model for one or more
  block types. Handles model file construction, registration, unit tests,
  codegen tests, screenshots, and verification. Usage: add-example <block-
  type(s)> [concept hint]
---
