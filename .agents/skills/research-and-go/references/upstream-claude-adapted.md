...
description: >-
  Z Skills workflow adapted for Codex: Full pipeline: decompose a broad goal
  into sub-plans, draft each with adversarial review, then execute all of them
  autonomously. One command, walk away. Usage: research-and-go <description>
---
