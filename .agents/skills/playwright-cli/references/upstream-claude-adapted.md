...
name: playwright-cli
description: >-
  Z Skills workflow adapted for Codex: Automates browser interactions for web
  testing, form filling, screenshots, and data extraction. Use when the user
  needs to navigate websites, interact with web pages, fill forms, take
